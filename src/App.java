...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        //Crear nodos
        NodeGraph<User> node1= new NodeGraph<User>(user1);
        NodeGraph<User> node2= new NodeGraph<User>(user2);
        NodeGraph<User> node3= new NodeGraph<User>(user3);
        NodeGraph<User> node4= new NodeGraph<User>(user4);
        NodeGraph<User> node5= new NodeGraph<User>(user5);
        ...
        System.out.println("Recomendaciones de amigos "+user1.getNombre()+":"+recommendations);
